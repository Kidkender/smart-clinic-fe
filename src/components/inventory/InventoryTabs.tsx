...
const TABS = [
  { to: '/inventory', label: 'Danh mục & tồn kho', icon: 'fa6-solid:boxes-stacked', end: true },
  { to: '/inventory/transactions', label: 'Xuất-nhập kho', icon: 'fa6-solid:right-left', end: true },
  { to: '/inventory/audits', label: 'Kiểm kê kho', icon: 'fa6-solid:clipboard-check', end: false },
];
